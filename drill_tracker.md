...
| ID | Title | Status |
|----|-------|--------|
| S001 | GCC Regulator — $80M financial inflation, 70K docs, dual-track keyword + journal methodology | ✅ Drilled (ladder + pushback) |
| S002 | UAE EPC — CEO looting $50M, email imaging, leaseback + shell company scheme | ✅ Extensively drilled (pushback ×3, multiple mocks) |
| S003 | GT 500K Transactions — PDF obstruction, OCR reconciliation engine | ✅ Drilled (ladder + pushback) |
| S004 | SWF Merlin Pilot — 683 funds, 100K docs, playbook-first then AI scaling | ✅ Drilled (targeted prep + mocks) |
| S005 | AML/KYC Frameworks — 4 banks, $273B combined assets, UAE Central Bank statute → controls | ❌ Never drilled |
| S006 | PlanLens/Scarlet — confidence-downgrade risk engine, founder period | ❌ Never drilled standalone (narrative covered in mocks) |
| S007 | Lebanese NGO — coaching detection, FX arbitrage scheme, OSINT backchannel | ✅ Drilled (mocks + pushback) |
...
|---|----------|--------|--------|
| **Career / Narrative** | | | |
| Q01 | Walk me through your background / career story | Anam (confirmed), prior rounds | ✅ Drilled |
| Q02 | Why did you leave [X] and join [Y]? (each transition) | Anam (confirmed) | ✅ Drilled |
| Q03 | Why Revolut? | Anam (confirmed) | ✅ Drilled |
...
| Q19 | Innovative solution you proposed? | QuantumLight playbook | ✅ Drilled (S004 + S003) |
| Q20 | How would you handle a task you've never done before? | QuantumLight playbook | ✅ Drilled (founder / Merlin) |
| **Team / People / Conflict** | | | |
...
## Critical Delivery Fixes (locked before interview)
