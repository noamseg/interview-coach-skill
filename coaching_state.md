...
- Interviewer intel: Becca (R1 screener — APAC talent). Kate Jordan (Group PM, Transactions — LinkedIn to be sent by Becca). Rebecca Holt (CCO — direct manager for this role). Patrick DiLoreto (Head of Product). Nicole Liu (Principal PM, peer level).
...
- Next round: TBD — Becca sending LinkedIn profiles of interviewers
